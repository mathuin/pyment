...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--source", dest="source", type=int, help="Crate from which jars are moved")
        parser.add_argument("--dest", dest="dest", type=int, help="Crate to which jars are moved")
