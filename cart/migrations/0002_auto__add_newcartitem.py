...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NewCartItem'
        db.create_table(u'cart_newcartitem', (
        ...
        db.send_create_signal(u'cart', ['NewCartItem'])


    def backwards(self, orm):
        # Deleting model 'NewCartItem'
        db.delete_table(u'cart_newcartitem')
