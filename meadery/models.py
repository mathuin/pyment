...
# They are used by recipes, batches, and products.
# The categories themselves are static.
# The descriptions are only used with products, and should be somewhere else.
...
class NewBatch(SIPParent):
    recipe = models.ForeignKey(Recipe, related_name='recipe', null=True, on_delete=models.SET_NULL)
    # Used for labels!
    event = models.CharField('Brewing event', max_length=20, help_text='Brewing event (e.g., Lughnasadh 2013, Samhain 2012, Imbolc 2011, Beltane 2010)')
    jars = models.IntegerField(help_text='Number of jars actually produced from this batch.')
