...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NewIngredientItem'
        db.create_table(u'meadery_newingredientitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'meadery', ['NewIngredientItem'])

        # Adding model 'NewRecipe'
        db.create_table(u'meadery_newrecipe', (
            (u'parent_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['meadery.Parent'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'meadery', ['NewRecipe'])

        # Adding model 'NewProduct'
        db.create_table(u'meadery_newproduct', (
            (u'parent_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['meadery.Parent'], unique=True, primary_key=True)),
        ...
        db.send_create_signal(u'meadery', ['NewProduct'])

        # Adding model 'NewBatch'
        db.create_table(u'meadery_newbatch', (
            (u'parent_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['meadery.Parent'], unique=True, primary_key=True)),
            ('brewname', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('batchletter', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recipe', null=True, on_delete=models.SET_NULL, to=orm['meadery.Recipe'])),
            ('event', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('jars', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'meadery', ['NewBatch'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'NewIngredientItem'
        db.delete_table(u'meadery_newingredientitem')

        # Deleting model 'NewRecipe'
        db.delete_table(u'meadery_newrecipe')

        # Deleting model 'NewProduct'
        db.delete_table(u'meadery_newproduct')

        # Deleting model 'NewBatch'
        db.delete_table(u'meadery_newbatch')
    ...
    models = {
        ...
        u'meadery.newbatch': {
            'Meta': {'ordering': "['-is_active', '-created_at']", 'object_name': 'NewBatch', '_ormbases': [u'meadery.Parent']},
            'batchletter': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'brewname': ('django.db.models.fields.CharField', [], {'max_length': '8'}),
            ...
            'recipe': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'recipe'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['meadery.Recipe']"}),
        ...
        u'meadery.newproduct': {
            'Meta': {'ordering': "['-is_active', '-created_at']", 'object_name': 'NewProduct', '_ormbases': [u'meadery.Parent']},
