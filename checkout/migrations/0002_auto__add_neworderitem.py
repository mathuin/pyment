...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NewOrderItem'
        db.create_table(u'checkout_neworderitem', (
        ...
        db.send_create_signal(u'checkout', ['NewOrderItem'])


    def backwards(self, orm):
        # Deleting model 'NewOrderItem'
        db.delete_table(u'checkout_neworderitem')
    ...
    models = {
        ...
        u'checkout.neworderitem': {
            'Meta': {'object_name': 'NewOrderItem'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
