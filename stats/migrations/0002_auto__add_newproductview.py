...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NewProductView'
        db.create_table(u'stats_newproductview', (
            ...
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meadery.NewProduct'])),
        ))
        db.send_create_signal(u'stats', ['NewProductView'])


    def backwards(self, orm):
        # Deleting model 'NewProductView'
        db.delete_table(u'stats_newproductview')
    ...
    models = {
        ...
        u'stats.newproductview': {
            'Meta': {'object_name': 'NewProductView'},
